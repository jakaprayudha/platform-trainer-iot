<div>
   ...
   <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
         ...
         <li class="sidebar-item">
            <a class="sidebar-link" href="device_interactive" aria-expanded="false">
               <iconify-icon icon="solar:danger-circle-line-duotone"></iconify-icon>
               <span class="hide-menu">Interaksi Perangkat</span>
            </a>
         </li>
         <li class="sidebar-item">
         ...
         <li class="sidebar-item">
            <a class="sidebar-link" href="praktikum_feedback" aria-expanded="false">
               <iconify-icon icon="solar:file-text-line-duotone"></iconify-icon>
               <span class="hide-menu">Umpan Balik</span>
            </a>
         </li>
         <li class="sidebar-item">
            <a class="sidebar-link" href="praktikum_progress" aria-expanded="false">
               ...
               <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                     ...
                     <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="hide-menu">Materi Praktikum</span>
                     </div>
                  </a>
               </li>
            </ul>
         ...
         <li class="sidebar-item">
            <a class="sidebar-link justify-content-between"
               href="automation_builder" aria-expanded="false">
               <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                     <iconify-icon icon="solar:airbuds-case-minimalistic-line-duotone" class=""></iconify-icon>
                  </span>
                  <span class="hide-menu">Automation Builder</span>
               </div>
               <span class="hide-menu badge bg-secondary-subtle text-secondary fs-1 py-1">Pro</span>
            </a>
         </li>
         ...
         <li class="sidebar-item">
            <a class="sidebar-link justify-content-between"
               href="notes" aria-expanded="false">
               <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
         ...
         <li class="sidebar-item">
            <a class="sidebar-link justify-content-between"
               href="cloud_iot" aria-expanded="false">
               <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                     <iconify-icon icon="solar:iphone-line-duotone" class=""></iconify-icon>
                  </span>
                  <span class="hide-menu">Cloud IoT Integration</span>
               </div>
               <span class="hide-menu badge bg-secondary-subtle text-secondary fs-1 py-1">Pro</span>
            </a>
         </li>
         <li class="sidebar-item">
            <a class="sidebar-link justify-content-between"
               ...
               <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu">AI Insight</span>
               </div>
               <span class="hide-menu badge bg-secondary-subtle text-secondary fs-1 py-1">Pro</span>
            </a>
         </li>
         <li class="sidebar-item">
            <a class="sidebar-link justify-content-between"
               href="sandbox_mode" aria-expanded="false">
               <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                     <iconify-icon icon="solar:bill-list-line-duotone" class=""></iconify-icon>
                  </span>
                  <span class="hide-menu">Sandbox Mode</span>
               </div>
               <span class="hide-menu badge bg-secondary-subtle text-secondary fs-1 py-1">Pro</span>
            </a>
         </li>
